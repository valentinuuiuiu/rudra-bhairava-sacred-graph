...
from .serializers import (
    ...
    ListingSerializer, ListingCreateSerializer, MessageSerializer,
    MessageCreateSerializer, FavoriteSerializer, FavoriteCreateSerializer
)
...
class ListingViewSet(viewsets.ModelViewSet):
    ...
    def favorite(self, request, pk=None):
        ...
        if created:
            return Response(
                {"detail": "Listing added to favorites"},
