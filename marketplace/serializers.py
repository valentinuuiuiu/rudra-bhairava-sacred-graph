...
class ListingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Listing
        fields = [
            'id', 'title', 'description', 'price', 'currency', 'location',
            'images', 'user', 'category', 'subcategory', 'status',
            'created_at', 'updated_at', 'expires_at', 'is_premium',
            'views', 'metadata', 'is_verified'
        ]
...
class MessageSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Message
        fields = ['id', 'sender', 'receiver', 'listing', 'content', 'created_at', 'is_read']
